...
fn generate_client_streaming<T: Service>(
    ...
    quote! {
        ...
        ) -> impl std::future::Future<Output = std::result::Result<tonic::Response<#response>, tonic::Status>> + std::marker::Send + '_
        where
            T: std::marker::Send,
            T::Future: std::marker::Send,
        {
            ...
            async move {
                ...
                inner.client_streaming(req, path, codec).await
            }
        }
    }
}
...
fn generate_streaming<T: Service>(
    ...
    quote! {
        pub fn #ident(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = #request>
        ) -> impl std::future::Future<Output = std::result::Result<tonic::Response<tonic::codec::Streaming<#response>>, tonic::Status>> + std::marker::Send + '_
        where
            T: std::marker::Send,
            T::Future: std::marker::Send,
        {
            ...
            async move {
                ...
                inner.streaming(req, path, codec).await
            }
        }
    }
}
